    ...
    public class TrackerClient
    {
        ...
        public static StorageServerInfo GetStoreStorage(string groupName)
        {
            ...
            try
            {
                ...
                string ipAddress =
                    new String(Util.ToCharArray(pkgInfo.Body), Protocol.FDFS_GROUP_NAME_MAX_LEN, Protocol.IP_ADDRESS_SIZE - 1).Trim();
                ...
                int port =
                    (int)Util.BufferToLong(pkgInfo.Body, Protocol.FDFS_GROUP_NAME_MAX_LEN + Protocol.IP_ADDRESS_SIZE - 1);
