...
namespace FastDFS.Client.Component
{
    public sealed class Protocol
    {
        ...
        public const byte TRACKER_PROTO_CMD_SERVICE_RESP = 100; //add mrt
        ...
        public const byte STORAGE_PROTO_CMD_RESP = TRACKER_PROTO_CMD_SERVICE_RESP;//add mrt
        ...
        public const int TRACKER_QUERY_STORAGE_STORE_BODY_LEN = FDFS_GROUP_NAME_MAX_LEN
                                                                + IP_ADDRESS_SIZE + FDFS_PROTO_PKG_LEN_SIZE;
        //Exit
